...
"""_summary_
      File "/home/nmulholland/generative_chem/moler_experiments/ppo/ppo_mso.py", line 20, in <module>
    opt = BasePSOptimizer.from_query(
  File "/home/nmulholland/generative_chem/mso_for_MoLeR/mso/optimizer.py", line 162, in from_query
    swarms = [
  File "/home/nmulholland/generative_chem/mso_for_MoLeR/mso/optimizer.py", line 163, in <listcomp>
    Swarm.from_query(
  File "/home/nmulholland/generative_chem/mso_for_MoLeR/mso/swarm.py", line 177, in from_query
...
class BasePSOptimizer:
    ...
    def _next_step_and_evaluate(self, swarm):
        ...
        """
        swarm.next_step()
        smiles = self.inference_model.emb_to_seq(swarm.x)
        swarm.smiles = smiles
        swarm.x = self.inference_model.seq_to_emb(swarm.smiles)
    ...
    def from_query(cls, init_smiles, num_part, num_swarms, inference_model,
                   scoring_functions=None, phi1=2., phi2=2., phi3=2., x_min=-10.,
                   x_max=10., v_min=-0.6, v_max=0.6, **kwargs):
        """
    ...
    @classmethod
    def from_swarm_dicts(cls, swarm_dicts, inference_model, scoring_functions=None, x_min=-10., x_max=10.,
...
class ParallelSwarmOptimizer(BasePSOptimizer):
    def _next_step_and_evaluate(self):
        ...
        smiles = self.inference_model.emb_to_seq(emb)
        x = self.inference_model.seq_to_emb(smiles)
